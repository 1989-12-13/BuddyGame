...
export const PROTOCOLS: ProtocolEntry[] = [
  ...
  { number: 14, title: '溺水/水域事故',            expectedDeterminant: '',    hotCold: 'HOT',  correctTriage: 'red' },
  { number: 15, title: '触电/雷击',              expectedDeterminant: '',    hotCold: 'HOT',  correctTriage: 'red' },
  ...
  { number: 27, title: '刺伤/枪伤/穿透伤',        expectedDeterminant: '27-D-2', hotCold: 'HOT',  correctTriage: 'red' },
  { number: 28, title: '卒中（脑血管意外）',         expectedDeterminant: '',    hotCold: 'HOT',  correctTriage: 'red' },
