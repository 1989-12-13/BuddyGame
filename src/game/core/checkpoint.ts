...
export function loadCheckpoint(): WorldState | null {
  try {
    ...
    if (!saved || saved.version !== 1 || !Array.isArray(saved.queue) || !saved.queue.length || saved.queue.length > 33 || !saved.queue.every((id: unknown) => typeof id === 'string' && SCENARIO_IDS.includes(id))) return null
