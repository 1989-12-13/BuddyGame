...
export const abdominalPainCard: EmergencyScenario = {
  ...
  guidance: {
    ...
    steps: [
      ...
      {
        id: 'abdominal_pain_mg',
        instruction: '保持平卧姿势，对腹部疼痛部位持续轻压缓解。',
        prompt: '实操环节：持续按压缓解腹痛',
        options: ['完成'],
        correctIndex: 0,
        feedback: {
          correct: '操作到位，正确执行。',
          incorrect: '操作需改进。',
          callerCorrect: '我躺下按着肚子了，好像好一点了……',
          callerIncorrect: '我一动肚子就疼得厉害……',
        },
        miniGame: {
          kind: 'holdPressure',
          title: '持续按压缓解腹痛',
          ...
          bleedRatePerSec: 10,
          regainPerSec: 16,
          feedback: { good: '我躺下按着肚子了，好像好一点了……', bad: '我一动肚子就疼得厉害……' },
        },
      },
    ],
  },
