...
export const animalBiteCard: EmergencyScenario = {
  ...
  guidance: {
    ...
    steps: [
      ...
      {
        id: 'animal_bite_mg',
        instruction: '在伤腿近心端找到股动脉止血点，对准位置后按压施压。',
        prompt: '实操环节：近心端动脉止血定位',
        options: ['完成'],
        correctIndex: 0,
        feedback: {
          correct: '操作到位，正确执行。',
          incorrect: '操作需改进。',
          callerCorrect: '我在大腿根部找到了动脉的位置按住了！血不流了！',
          callerIncorrect: '我手抖没找准位置……血还在渗……',
        },
        miniGame: {
          kind: 'holdPressure',
          title: '近心端动脉按压止血',
          instruction: '找到伤口近心端的股动脉止血点（大腿根部），用布料持续用力按压止血，保持压力不要松手。',
          passThreshold: 0.5,
          holdSec: 8,
          bleedRatePerSec: 12,
          regainPerSec: 18,
          feedback: { good: '我在大腿根部找到了动脉的位置按住了！血不流了！', bad: '我手抖没找准位置……血还在渗……' },
        },
      },
    ],
  },
