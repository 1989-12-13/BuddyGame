...
export const assaultCard: EmergencyScenario = {
  ...
  guidance: {
    ...
    steps: [
      ...
      {
        id: 'assault_mg',
        instruction: '在头部侧面找到颞动脉止血点，对准后按压施压。',
        prompt: '实操环节：颞动脉止血定位',
        options: ['完成'],
        correctIndex: 0,
        feedback: {
          correct: '操作到位，正确执行。',
          incorrect: '操作需改进。',
          callerCorrect: '我按住了他脸上的动脉！血止住了不少！',
          callerIncorrect: '我手一滑没按住，血又流出来了……',
        },
        miniGame: {
          kind: 'holdPressure',
          title: '近心端动脉按压止血',
          instruction: '找到伤口近心端的颞动脉止血点（头部侧面），用布料持续用力按压止血，保持压力不要松手。',
          passThreshold: 0.5,
          holdSec: 8,
          bleedRatePerSec: 14,
          regainPerSec: 20,
          feedback: { good: '我按住了他脸上的动脉！血止住了不少！', bad: '我手一滑没按住，血又流出来了……' },
        },
      },
    ],
  },
