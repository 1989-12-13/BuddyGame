    ...
    steps: [
      ...
      },
      {
        ...
        feedback: {
          correct: '按压到位。',
          incorrect: '按压不达标。',
          callerCorrect: '我按了！他胸口在动！',
          callerIncorrect: '我按得太乱了，感觉没节奏。',
        },
        miniGame: {
          kind: 'rhythmPress',
          title: '胸外按压实操',
          instruction: '按空格或点击中央按压区，跟随节奏保持每分钟约110次按压，持续15秒。',
          passThreshold: 0.5,
          targetBpm: 110,
          bpmTolerance: 12,
          durationSec: 15,
          feedback: { good: '我按了！他胸口在动！', bad: '我按得太乱了，感觉没节奏。' },
        },
      },
      {
        id: 'cpr_blow_game',
        instruction: '进行人工呼吸吹气。',
        prompt: '实操环节：人工呼吸',
        options: ['完成吹气'],
        correctIndex: 0,
        feedback: {
          correct: '吹气到位。',
          incorrect: '吹气不达标。',
          callerCorrect: '我看到他胸口起来了！',
          callerIncorrect: '我吹的时间没把握好。',
        },
        miniGame: {
          kind: 'blowInflate',
          title: '人工呼吸吹气',
          instruction: '按住空格向患者肺部吹气，让胸廓隆起约1秒后松开，重复2次。注意不要过量以免胃胀气。',
          passThreshold: 0.5,
          targetInflations: 2,
          idealHoldSec: 1,
          overInflationSec: 2,
          durationSec: 15,
          feedback: { good: '我看到他胸口起来了！', bad: '我吹的时间没把握好。' },
        },
      },
      {
        id: 'cpr_shock_game',
        ...
        feedback: {
          correct: '除颤到位。',
          incorrect: '除颤不达标。',
          callerCorrect: '电击了！他弹了一下！',
          callerIncorrect: '我按早了，提示说不是可电击。',
        },
        miniGame: {
          kind: 'timedShock',
          title: 'AED 除颤',
          instruction: '取来AED贴好电极片，波形变红即可电击时立即按下 SHOCK 按钮，注意只在可电击窗口内按下。',
          passThreshold: 0.5,
          windows: 2,
          windowMs: 1500,
          shockCooldownMs: 2500,
          falsePenalty: 0.25,
          feedback: { good: '电击了！他弹了一下！', bad: '我按早了，提示说不是可电击。' },
        },
      },
    ],
  },
