...
export const chemicalBurnCard: EmergencyScenario = {
  ...
  guidance: {
    ...
    steps: [
      ...
      {
        id: 'chemical_burn_mg',
        instruction: '找到眼部冲洗的最佳水流位置（内眼角侧），将施力点对准后锁定持续冲洗。',
        prompt: '实操环节：眼部冲洗定位',
        options: ['完成'],
        correctIndex: 0,
        feedback: {
          correct: '操作到位，正确执行。',
          incorrect: '操作需改进。',
          callerCorrect: '我对着他眼睛冲了！他在喊疼但是水冲进去了！',
          callerIncorrect: '我位置没对准，水全流到脸上了……',
        },
        miniGame: {
          kind: 'aimForce',
          title: '眼部冲洗定位',
          ...
          thrusts: 1,
          thrustWindowMs: 800,
          feedback: { good: '我对着他眼睛冲了！他在喊疼但是水冲进去了！', bad: '我位置没对准，水全流到脸上了……' },
        },
      },
    ],
  },
