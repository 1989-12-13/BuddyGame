...
export const stabGunshotCard: EmergencyScenario = {
  ...
  guidance: {
    ...
    steps: [
      ...
      {
        id: 'stab_mg',
        instruction: '在伤口近心端找到锁骨下动脉止血点，对准位置后按压施压。',
        ...
        feedback: {
          ...
          incorrect: '操作需改进。',
          callerCorrect: '我绕开刀在锁骨上方找到了动脉按住了！血没再喷了！',
          callerIncorrect: '我没找准位置，血还在往外涌……',
        },
        miniGame: {
          kind: 'holdPressure',
          title: '近心端动脉按压止血',
          instruction: '找到伤口近心端的锁骨下动脉止血点（锁骨上方），用布料绕开异物持续用力按压止血，保持压力不要松手。',
          passThreshold: 0.5,
          holdSec: 8,
          bleedRatePerSec: 16,
          regainPerSec: 24,
          feedback: { good: '我绕开刀在锁骨上方找到了动脉按住了！血没再喷了！', bad: '我没找准位置，血还在往外涌……' },
        },
      },
    ],
  },
